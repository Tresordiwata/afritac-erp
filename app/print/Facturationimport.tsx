        ...
        <Page size={"A4"}  style={styles.page}>
          <View style={styles.header}>
            ...
            <View style={{ display: "flex", flexDirection: "column" }}>
              ...
              <View
                style={[styles.companyInfo, { marginTop: 3, marginLeft: -70 }]}
              >
          ...
          <View style={{ display: "flex", flexDirection: "row" }}>
            <Text
              style={[styles.companyText, { color: "#AFA316", width: "50%" }]}
            >
              Date de la facture
            </Text>
            <Text
          ...
          >
            ...
            >
              <Text style={{ fontSize: 8, fontWeight: "bold", width: "25%" }}>
                Camion :{" "}
              </Text>
              <Text style={{ fontSize: 8, fontWeight: "bold", width: "25%" }}>
                N° T-1 :{" "}
            ...
            >
              ...
              <Text style={{ fontSize: 8, fontWeight: "normal", width: "25%" }}>
                {facture?.t1}
              </Text>
              <Text style={{ fontSize: 8, fontWeight: "normal", width: "25%" }}>
            ...
            <View style={{marginTop:170, fontSize:6, borderTop:"2px solid #000"}}>
              <Text style={{textAlign:"center"}}>info@afritac.com   http://www.afritac.com Tax ID: 1882/2013</Text>
              <Text style={{textAlign:"center", marginTop:4}}>EQUITY:00018-00016-01217961200-89 USD (SWIFT:BCDCCDKIXXX) | RAWBANK:05100-05100-05130-01010892901-41 USD (SWIFT:RAWBCDKI)</Text>
              <Text style={{textAlign:"center", marginTop:4}}>FBN:00014-25000-20300063213-57 USD(SWIFT:BICDCDKI) | TMB:00017-25000-00257700100-23 USD(SWIFT:TRMSCD3L) | ECOBANK:00026000043520002702683 USD(SWIFT:ECOCCDKI)</Text>
            </View>
          </View>
        </Page>
      </Document>
