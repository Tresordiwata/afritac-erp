        ...
        <Page size={"A5"}  style={styles.page}>
          <View style={styles.header}>
                    ...
                    <View style={{ display: "flex", flexDirection: "column",alignItems:"flex-end", justifyContent:"flex-end" }}>
                      <View style={{alignContent:"flex-end", display:"flex", flexDirection:"column", justifyContent:"flex-end", alignItems:"flex-end", fontSize:8}}>
                        <Text style={entete}>
                      ...
                      <View style={[styles.companyInfo, { marginTop: 20 }]}>
                        <Text
                          style={[styles.companyText, styles.bold, { color: "#072BAF" }]}
                        >
                        ...
                        <Text style={styles.companyText}>{invoice?.client?.adresse}</Text>
                      </View>
                    </View>
                  </View>
                  ...
                  >
                    ...
                    >
                      <Text style={{ fontSize: 12, color: "gray" }}>
                        Lubumbashi, le {moment(invoice?.datePaiement).format("DD/MM/YYYY")}{" "}
                      </Text>
                    </View>
                    <View
                      style={{
